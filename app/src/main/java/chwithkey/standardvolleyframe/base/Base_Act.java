...
import chwithkey.standardvolleyframe.emptyPage.EmptyPage_Frag;
import chwithkey.standardvolleyframe.loadMore.RemoveLoadMoreImpl;
import chwithkey.standardvolleyframe.netDown.NetDown_Frag;
...
public abstract class Base_Act extends AppCompatActivity implements RemoveLoadMoreImpl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = this.getSharedPreferences(SharedAction.FILE_NAME, MODE_PRIVATE);
    ...
    private void tbInit(int toolbarColorResId) {
        toolbar = (Toolbar) findViewById(R.id.toolbar_tb);
        // title_tv = (TextView) findViewById(R.id.toolbar_tv);

        toolbar.setTitle("");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            toolbar.setBackground(getDrawable(toolbarColorResId));
        } else {
            toolbar.setBackgroundDrawable(getResources().getDrawable(toolbarColorResId));
        }
     ...
     */
    protected void setTbTitle(String title, int toolbarColorResId, int titleColorResId) {
        tbInit(toolbarColorResId);
